...
public class UserMenuPanel extends GeneralMenu {
    private final String USER_TYPE_MENU = """
                Choose user type: 
                    ...
                    3 - Faculty
                """;
    private final String USER_CONTROL_PANEL = """
            1 - Add User
            2 - Remove User
            3 - Display all Users
    ...
    public UserMenuPanel(AdvancedMenu menu) {
    ...
    public void start() {
        ...
        while(true) {
            try {
                runnable = GENERAL_MAP.get(askQuestion(USER_CONTROL_PANEL));
                break;
